        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Pemasukan Kas KarTar</h5>
                ...
                <form action={{ url('kas-masjid/pemasukan/tambah') }} method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control masjid" placeholder="Pemasukan" name="masuk"
                                autocomplete="off" onkeyup="formatbaru(event)">
                        </div>
                        <div class="mb-3">

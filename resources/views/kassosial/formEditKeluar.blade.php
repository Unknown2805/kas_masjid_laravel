        ...
        <div class="modal-body">
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text"  class="form-control" value="{{ $d->keluar}}" id="editos" placeholder="Another input placeholder" name="keluar" autocomplete="off" onkeyup="formatbaru(event)">
              </div>
              <div class="mb-3">
